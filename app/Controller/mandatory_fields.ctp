<div class="row">
    <div class="col-sm-8">
        ...
        <div class="form-group formField">
            ...
            <div class="col-md-10">
                <div class="radio">
                    <label><input type="radio" value="same-village" name="mand-birth-place" checked/>Same Place</label>
                </div>
                <div class="radio">
        ...
        <div class="form-group formField">
            <label class="col-md-2 control-label">Arogya Sakhi*:</label>
            <div class="col-md-10">
                <select class="form-control" id="mand-arogya-sakhi" name="mand-arogya-sakhi">
                    <option value="null"> </option>
                    <?php
                    foreach($manager as $m) {
                        $sakhiname = $m['managers']['fname'].' '.$m['managers']['lname'];
                        $opt[] = array('value'=>$m['managers']['id'],'name'=>$sakhiname,'class'=>'form-control');
                        echo '<option value="$m["managers"]["id"]">'.$sakhiname.'</option>';
                    }
                    ?>
                    <?php //echo $this->Form->input('manager_id', array('type' => 'select', 'options' => $opt, 'label' => false, 'div' => FALSE)); ?>
                </select> 
            </div>
        </div>
    </div>
