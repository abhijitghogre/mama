        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group formField">
                    ...
                    <div class="col-sm-10">
                        <?php echo $this->Form->input('project_name', array('label' => false, 'class' => 'form-control', 'placeholder' => 'Project name', 'id' => 'inputproject')); ?>
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <?php
                        echo $this->Form->submit('Add', array('class' => 'btn btn-primary', 'title' => 'Add project'));
                        echo $this->Form->end();
                        ?>
                    </div>
                </div>
